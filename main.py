...
def signup():
    ...
    if not error_username and error_passwords and error_verifypasswords and error_email:
        return render_template('confirmation.html', username=username)
    else:
        return render_template('edit.html', error_username=error_username, error_passwords=error_passwords, error_verifypasswords=error_verifypasswords, error_email=error_email)
